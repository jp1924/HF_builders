...
DESCRIPTION = "2022년 일상 대화 말뭉치 구축(2022)"
HOMEPAGE = "https://kli.korean.go.kr/corpus/main/requestMain.do?tabType=thumb&lang=ko&keyword=%EC%9D%BC%EC%83%81%20%EB%8C%80%ED%99%94%20%EB%A7%90%EB%AD%89%EC%B9%98%202022#down"
LICENSE = "https://kli.korean.go.kr/corpus/boards/termsInfo.do"
VERSION = "1.0.0"


class EverydayConversationCorpus2022(GeneratorBasedBuilder):
