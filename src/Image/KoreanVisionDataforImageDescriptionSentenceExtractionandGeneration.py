...
_DESCRIPTION = """한국 상황을 잘 설명할 수 있는 한국형 객체인식 데이터셋 구축하기 위해 300만장의 이미지로부터 한글/영문 각 10개의 설명문을 도출함"""
...
class KoreanVisionDataforImageDescriptionSentenceExtractionandGeneration(GeneratorBasedBuilder):
    BUILDER_CONFIGS = [
        BuilderConfig(
            ...
            version="1.1.0",
            data_dir="object",
            description="객체 데이터" + _DESCRIPTION,
        ),
        BuilderConfig(
            name="caption",
            version="1.1.0",
            data_dir="caption",
            description="캡션 데이터" + _DESCRIPTION,
        ),
    ]
