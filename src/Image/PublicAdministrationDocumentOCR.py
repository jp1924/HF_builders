...
_DESCRIPTION = """공공 행정 문서에 특화된 문자 인식 AI 모델을 개발하기 위한 공공 행정 문서 이미지 데이터"""
...
class PublicAdministrationDocumentOCR(GeneratorBasedBuilder):
    BUILDER_CONFIGS = [
        BuilderConfig(name="chat", version="1.2.0", description=_DESCRIPTION),
        BuilderConfig(name="ocr", version="1.2.0", description=_DESCRIPTION),
    ]
